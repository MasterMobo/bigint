...
struct StringConversionTest: testing::Test {
    ...
    StringConversionTest() {
        binString = new std::string("101001110100101011101010010101000111110100111010101000101010011100011001111");
        decString = new std::string("478922353498192387143528927348923483122389472398465239823489273423489273423431846124891246235");
    }
    ~StringConversionTest() {
        delete binString;
        delete decString;
